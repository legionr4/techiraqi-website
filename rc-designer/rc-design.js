...
function calculateAerodynamics() {
    ...
    const fuselageLength = getValidNumber(fuselageLengthInput) * conversionFactor; // Already read, but good to have it here
...
function updateAll() {
    // الاستدعاء الأول: لحساب القيم الأولية التي قد تحتاجها updatePlaneModel
    calculateAerodynamics();
    updatePlaneModel();
    // الاستدعاء الثاني: لإعادة الحساب بالكامل بعد تحديث النموذج وضمان دقة جميع الأوزان والأبعاد
    calculateAerodynamics();
